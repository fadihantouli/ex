...
class TravelFormsForm extends StatefulWidget {
  const TravelFormsForm({super.key});

  @override
  State<TravelFormsForm> createState() => _TravelFormsFormState();
}

class _TravelFormsFormState extends State<TravelFormsForm> {
  @override
    ...
    return BlocConsumer<ServiceCubit, ServiceState>(
      ...
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            Text(S.of(context)!.typeOfFormToBeFilled, style: Theme.of(context).textTheme.bodyMedium,),
            const SizedBox(height: 10,),
            buildDropdownButton(
                onChange: (value) {
                  setState(() {
                    cubit.selectModelType = value;
                  });
                },
                hint: S.of(context)!.typeOfFormToBeFilled,
                item: [
                  S.of(context)!.embassyForm,
                  S.of(context)!.bookHotel,
                  S.of(context)!.bookFlight,
                  S.of(context)!.bookHotelAndFlight].map((value) {
