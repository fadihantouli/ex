...
class DuolingoTestForm extends StatefulWidget {
  const DuolingoTestForm({super.key});

  @override
  State<DuolingoTestForm> createState() => _DuolingoTestFormState();
}

class _DuolingoTestFormState extends State<DuolingoTestForm> {
  @override
